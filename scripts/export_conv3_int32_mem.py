...
SRC_INPUT_MEM = r"D:/Users/Lenovo/project_1/muse_cnn_sources/data/pool2_expected_int32.mem"
SRC_W_FLOAT = r"C:/Users/Lenovo/Documents/muse-eeg-real-time-inference/fpga/weights/conv1d_7_w0.npy"
SRC_B_FLOAT = r"C:/Users/Lenovo/Documents/muse-eeg-real-time-inference/fpga/weights/conv1d_7_w1.npy"
SRC_W_INT8_CANDIDATES = [
    r"C:/Users/Lenovo/Documents/muse-eeg-real-time-inference/fpga/test_vectors/conv3_weights_int8.npy",
    r"C:/Users/Lenovo/Documents/muse-eeg-real-time-inference/fpga/weights/conv1d_7_w0_int8.npy",
]

DST_INPUT_MEM = r"D:/Users/Lenovo/project_1/muse_cnn_sources/data/conv3_input.mem"
DST_W_MEM = r"D:/Users/Lenovo/project_1/muse_cnn_sources/weights/conv3_w.mem"
DST_B_MEM = r"D:/Users/Lenovo/project_1/muse_cnn_sources/weights/conv3_b.mem"
DST_EXPECTED_MEM = r"D:/Users/Lenovo/project_1/muse_cnn_sources/data/conv3_expected_int32.mem"
DST_META = r"D:/Users/Lenovo/project_1/muse_cnn_sources/data/conv3_export_metadata.txt"
...
def main():
    ...
    if tuple(w_float.shape) != (K, C_IN, F_OUT):
        raise ValueError("Conv3 weight shape mismatch: %s" % (w_float.shape,))

    b_float = np.load(SRC_B_FLOAT)
    if tuple(b_float.shape) != (F_OUT,):
        raise ValueError("Conv3 bias shape mismatch: %s" % (b_float.shape,))
    ...
    bias_mode = "zero_bias_placeholder_for_raw_integer_conv3_alignment"
    ...
    with open(DST_META, "w") as f:
        ...
        f.write("pad_left: 1\n")
        f.write("stride: 1\n")
        f.write("flatten_input: for t in range(750): for c in range(32): write input[t,c]\n")
        f.write("flatten_weights: for f in range(64): for k in range(3): for c in range(32): write weight[k,c,f]\n")
        f.write("flatten_bias: for f in range(64): write bias[f]\n")
        f.write("flatten_expected: for t in range(750): for f in range(64): write output[t,f]\n")
