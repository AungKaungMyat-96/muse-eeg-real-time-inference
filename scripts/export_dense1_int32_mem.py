...
SRC_INPUT_MEM = r"D:/Users/Lenovo/project_1/muse_cnn_sources/data/gap_expected_int32.mem"
SRC_W_FLOAT = r"C:/Users/Lenovo/Documents/muse-eeg-real-time-inference/fpga/weights/dense_4_w0.npy"
SRC_B_FLOAT = r"C:/Users/Lenovo/Documents/muse-eeg-real-time-inference/fpga/weights/dense_4_w1.npy"
SRC_W_INT8_CANDIDATES = [
    r"C:/Users/Lenovo/Documents/muse-eeg-real-time-inference/fpga/test_vectors/dense1_weights_int8.npy",
    r"C:/Users/Lenovo/Documents/muse-eeg-real-time-inference/fpga/weights/dense_4_w0_int8.npy",
]
SRC_B_INT32_CANDIDATES = [
    r"C:/Users/Lenovo/Documents/muse-eeg-real-time-inference/fpga/test_vectors/dense1_bias_int32.npy",
    r"C:/Users/Lenovo/Documents/muse-eeg-real-time-inference/fpga/weights/dense_4_w1_int32.npy",
]

DST_INPUT_MEM = r"D:/Users/Lenovo/project_1/muse_cnn_sources/data/dense1_input.mem"
DST_W_MEM = r"D:/Users/Lenovo/project_1/muse_cnn_sources/weights/dense1_w.mem"
DST_B_MEM = r"D:/Users/Lenovo/project_1/muse_cnn_sources/weights/dense1_b.mem"
DST_EXPECTED_MEM = r"D:/Users/Lenovo/project_1/muse_cnn_sources/data/dense1_expected_int32.mem"
DST_META = r"D:/Users/Lenovo/project_1/muse_cnn_sources/data/dense1_export_metadata.txt"
...
def main():
    ...
    if tuple(w_float.shape) != (IN_DIM, OUT_DIM):
        raise ValueError("Dense1 weight shape mismatch: %s" % (w_float.shape,))

    b_float = np.load(SRC_B_FLOAT)
    if tuple(b_float.shape) != (OUT_DIM,):
        raise ValueError("Dense1 bias shape mismatch: %s" % (b_float.shape,))
    ...
    if b_i32 is None:
        ...
        b_source = "none"
        b_rule = "zero_bias_placeholder_for_raw_integer_dense1_alignment"
    ...
    with open(DST_META, "w") as f:
        ...
        f.write("activation_in_expected: none_raw_dense1_preactivation\n")
        f.write("flatten_input: for i in range(64): write input[i]\n")
        f.write("flatten_weights: for o in range(32): for i in range(64): write w[i,o]\n")
        f.write("flatten_bias: for o in range(32): write b[o]\n")
        f.write("flatten_expected: for o in range(32): write y[o]\n")
