...
module dense1_int32 #(
    ...
    initial begin
        ...
        wf = $fopen("D:/Users/Lenovo/project_1/muse_cnn_sources/weights/dense1_w.mem", "r");
        if (wf != 0) begin
            i = 0;
        ...
        bf = $fopen("D:/Users/Lenovo/project_1/muse_cnn_sources/weights/dense1_b.mem", "r");
        if (bf != 0) begin
            i = 0;
