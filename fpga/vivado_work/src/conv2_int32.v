...
module conv2_int32 #(
    ...
    reg signed [W_W-1:0]  weight_mem [0:WEIGHT_COUNT-1];
    ...
    initial begin
        ...
        wf = $fopen("D:/Users/Lenovo/project_1/muse_cnn_sources/weights/conv2_w.mem", "r");
        if (wf != 0) begin
            i = 0;
        ...
        bf = $fopen("D:/Users/Lenovo/project_1/muse_cnn_sources/weights/conv2_b.mem", "r");
        if (bf != 0) begin
            i = 0;
