...
The first FPGA implementation target is the first Conv1D layer of the CNN model.

Prepared assets:
- Quantized int8 input vector
- Quantized int8 Conv1 weights
- Reference int32 Conv1 output
- Float Conv1, ReLU, and MaxPool reference outputs

This enables direct comparison between Python reference outputs and future FPGA hardware outputs.